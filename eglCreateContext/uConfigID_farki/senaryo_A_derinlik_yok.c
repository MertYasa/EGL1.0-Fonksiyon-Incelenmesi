...
int main() {
    ...
    printf("DEGER A: config = EGL_DEPTH_SIZE 0.\n");
    printf(" -> GORSEL SONUC: Derinlik tamponu yok. Son cizilen mavi ucgen kirmizinin ustune biner.\n");
    printf("    Bu config ile z sirasi ekranda korunmaz; cizim sirasi belirleyici olur.\n\n");
